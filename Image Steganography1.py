...
root = Tk()
root.title("Stego Crypt A new approach towards security")
...
Label(root, text="Integration of Cryptographic Model with Image Steganography", bg="#2d4155", fg="white", font="arial 15 bold").place(x=100, y=20)
